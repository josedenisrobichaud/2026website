---
title: 🐄 First Data Collection in Dairy Farms of Bas-Saint-Laurent
summary: Since November, we have started collecting samples for a uterine health project.
date: 2026-01-01

# Featured image
# Place an image named `featured.jpg/png` in this page's folder and customize its options here.
image:
  caption: 'Sabrina, Hélène, and José'
...
This [project]({{< relref "../projects/marqueurs" >}}), led by Marcio Costa, aims to establish links between microbiota composition and reproductive performance in cows. By identifying microbial profiles associated with good uterine health, we hope to develop predictive tools that can help producers optimize reproduction management on their farms.  
