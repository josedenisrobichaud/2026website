...
image:
  caption: 'Source: Adobe Stock; Copyright: utaem2022; License: Standard'
  focal_point: ""
  preview_only: false
...
Développement d'outils d'aide à la décision pratiques pour supporter les vétérinaires et les producteurs à utiliser les données de ferme pour prendre de meilleures décisions de gestion de la santé, plus rapidement.
<!--more-->
